...
export default function Terms() {
  return (
    <LegalPage
      ...
      description="The terms that apply when using SocialHub."
    >
      <p className="lead">
        By creating an account or using SocialHub, you agree to these terms.
      </p>

      <section>
        <h2>Using SocialHub</h2>
        <p>
      ...
      <section>
        <h2>Your content</h2>
        <p>
          You retain ownership of content you submit. You grant SocialHub a
      ...
      <section>
        ...
        <p>
          ...
          use SocialHub for illegal activity. We may remove content or restrict
      ...
      <section>
        ...
        <p>
          SocialHub may rely on third-party identity, hosting, media, and
      ...
      <section>
        ...
        <p>
          SocialHub is provided on an as-available basis. Features may change, be
      ...
      <section>
        <h2>Ending use</h2>
        <p>
          You may stop using SocialHub or request account deletion. We may suspend
